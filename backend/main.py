    ...
    try:
        ...
        try:
            columns_to_add = [
                ...
                ('terms', 'VARCHAR(100)'),
                ('module_hours', 'VARCHAR(100)'),
                ('number_of_classes', 'VARCHAR(100)'),
                ('class_name', 'VARCHAR(255)'),
                ('trainer_name', 'VARCHAR(255)'),
                ('term1_weeks', 'TEXT'),
                ('term1_competence', 'TEXT'),
                ('term1_learning_outcomes', 'TEXT'),
                ('term1_indicative_contents', 'TEXT'),
                ('term1_duration', 'TEXT'),
                ('term1_learning_place', 'TEXT'),
                ('term2_weeks', 'TEXT'),
                ('term2_competence', 'TEXT'),
                ('term2_learning_outcomes', 'TEXT'),
                ('term2_indicative_contents', 'TEXT'),
                ('term2_duration', 'TEXT'),
                ('term2_learning_place', 'TEXT'),
                ('term3_weeks', 'TEXT'),
                ('term3_competence', 'TEXT'),
                ('term3_learning_outcomes', 'TEXT'),
                ('term3_indicative_contents', 'TEXT'),
                ('term3_duration', 'TEXT'),
                ('term3_learning_place', 'TEXT'),
